package com.dev.app.zuul.oauth2;
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter{
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET, "/api/products/view/{id}", "/api/items/view/{id}/cantidad/{quantity}", "/api/users/users/{id}").hasAnyRole("ADMIN", "USER")
